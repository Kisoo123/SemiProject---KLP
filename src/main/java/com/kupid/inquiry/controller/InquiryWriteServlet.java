 ...
 */
@WebServlet("/inquery/inquerywrite.do")
public class InquiryWriteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher(getServletContext().getInitParameter("viewpath")+"inquiry/inquirywrite.jsp").forward(request, response);
	}
